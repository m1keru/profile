...
<details>
  ...
  <ul>
    <li>IBM Cloud Classic</li>
    <li>Bitbucket</li>
    <li>AWS</li>
    <li>Terraform</li>
    <li>Puppet</li>
    <li>LXD/LXC</li>
    <li>MySQL, MongoDB, PostgreSQL, Redis, Kafka</li>
    <li>Grafana, VictoriaMetrics, Alertmanager</li>
    <li>Kibana, ElasticSearch, Vector, Beats</li>
...
<details>
  <summary>Stack</summary>
  <ul>
    <li>Bare-metal servers in 7 datacenters spreaded by geo.</li>
    <li>Github</li>
    <li>Clouderra Hadoop</li>
    <li>Airflow</li>
    <li>Spark</li>
    <li>HBase</li>
    <li>Vertica</li>
    <li>Snowflake</li>
    <li>AWS (EC2, S3, EMR, EKS, Kenesis, SQS, SNS)</li>
    <li>Terraform</li>
    <li>Puppet</li>
    <li>Ansible</li>
    <li>Chef</li>
    <li>Kafka</li>
    <li>MySQL, MongoDB, PostgeSQL, Redis, Kafka</li>
    <li>Grafana, Prometheus, Alertmanager</li>
    <li>Kibana, ElasticSearch,Beats</li>
    <li>Python</li>
  </ul>
</details>
...
<details>
  <summary>Stack</summary>
  <ul>
    <li>Bare-metal HPE servers</li>
    <li>HPE Storage and networking</li>
    <li>Terraform</li>
    <li>Ansible</li>
    <li>Hashicorp nomad</li>
    <li>Hashicorp consul</li>
    <li>MySQL, PostgeSQL Patroni, Redis</li>
    <li>Self-Hosted k8s</li>
    <li>Gitlab</li>
    <li>Sentry</li>
    <li>Grafana, Prometheus, Alertmanager</li>
    <li>Golang</li>
...
<details>
  <summary>Stack</summary>
  <ul>
    <li>Bare-metal DELL servers</li>
    <li>DELL Storage, Brocade access layer</li>
    <li>Gitlab</li>
    <li>Ansible</li>
    <li>PostgreSQL</li>
    <li>Docker CE</li>
...
<details>
  ...
  <ul>
    <li>PostgreSQL</li>
    <li>Self-hosted SVN and GIT</li>
    <li>C/C++</li>
    <li>SVN</li>
    <li>GIT</li>
    <li>OpenVZ Containers</li>
    <li>Zabbix</li>
    <li>ElasticSearch</li>
    <li>SphinxSearch</li>
    <li>Python</li>
